        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-red-600 hover:bg-red-500 text-white font-bold text-xs sm:text-sm flex items-center gap-2 shadow-lg shadow-red-600/30 active:scale-95 transition-all"
            >
          ...
          {SERVICES_24X7.map((srv, idx) => {
            ...
            return (
              <div
                ...
                className={`bg-slate-800/80 hover:bg-slate-800 border border-slate-700/80 hover:border-slate-600 rounded-2xl p-5 transition-all duration-200 flex flex-col justify-between group ${
